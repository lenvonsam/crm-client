<template lang="pug">
div
  el-table(:data="tableValue.tableData", style="width: 100%", border, v-if="tableValue", @selection-change="handleSelectionChange", :default-sort="{order: 'descending'}", size="medium", header-cell-class-name="crm-table-head-bg", :filter-change="tableFiler")
