  ...
  export default {
    ...
    data () {
      return {
        ...
        searchFormItems: [
          {label: '加工需求代码', model: 'id', type: 'text', placeholder: '请输入加工需求代码', val: ''},
          {label: '加工需求名称', model: 'name', type: 'text', placeholder: '请输入加工需求名称', val: ''}
        ],
        tableValue: {
          tableData: [{
            id: 1,
        ...
        prompt: {
          title: '新增加工需求',
          items: [{label: '加工需求', model: 'busiRelation', type: 'text', placeholder: '请输入加工需求', val: ''}]
        },
        promptShow: false
      }
    },
