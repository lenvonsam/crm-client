    ...
    el-tabs(type="border-card", v-model="activeName")
      el-tab-pane(label="角色设置", name="role")
        template(v-if="tabModel == 'roleList'")
          ...
          .pt-10
            basic-table(:tableValue="roleTableValue", :currentPage="currentPage", :pageSize="pageSize", :total="totalCount", @tableRowEdit="rowEdit", @tableRowDelete="rowDelete", @chooseData="selectData", @pageChange="tablePgChange")
  ...
  export default {
    ...
    methods: {
      ...
      nextStep () {
        ...
        if (this.tabModel === 'roleFormUpdate') {
          // 更新数据
      ...
      rowEdit (obj) {
        ...
        this.tabModel = this.activeName === 'role' ? 'roleFormUpdate' : 'authFormUpdate'
      },
      rowDelete (obj) {
